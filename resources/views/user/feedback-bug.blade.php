                            ...
                            @else
                                @foreach ($feedback as $f)
                                    <tr class="bg-white border-b text-nowrap">
                                        ...
                                        <td class="px-6 py-4">
                                            <button aria-haspopup="dialog" aria-expanded="false"
                                                aria-controls="hs-scale-animation-modal-edit-feedback-{{ $f->id }}"
                                                data-hs-overlay="#hs-scale-animation-modal-edit-feedback-{{ $f->id }}"
                                    ...
                                    <!-- Modal Edit Feedback -->
                                    <div id="hs-scale-animation-modal-edit-feedback-{{ $f->id }}"
                                        class="hs-overlay hs-overlay-backdrop-open:bg-black/80 hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none"
                                        role="dialog" tabindex="-1"
                                        aria-labelledby="hs-scale-animation-modal-label-edit-feedback-{{ $f->id }}">
                                        <div
                                            class="hs-overlay-animation-target hs-overlay-open:scale-100 hs-overlay-open:opacity-100 scale-95 opacity-0 ease-in-out transition-all duration-200 sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
                                            <div
                                                class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
                                                ...
                                                <div class="p-4 overflow-y-auto">
                                                    <form action="{{ route('feedback.update', $f->id) }}"
                                                        method="POST" class="grid gap-1">
                                                        @csrf
                                                        @method('PUT')
                                                        <div>
                                                            <label for="feedback"
                                                            ...
                                                            <textarea id="feedback" name="feedback" class="custom-input h-32" required
                                                                oninvalid="this.setCustomValidity('Kolom ini harus diisi')" oninput="this.setCustomValidity('')">{{ old('feedback', $f->feedback) }}</textarea>
                                                        </div>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div class="p-4 overflow-y-auto">
                                                    ...
                                                    <div class="flex justify-end mt-4">
                                                        <form action="{{ route('feedback.destroy', $f->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                            ...
                            @else
                                @foreach ($bug as $b)
                                    <tr class="bg-white border-b text-nowrap">
                                        ...
                                        <td class="px-6 py-4">
                                            <button aria-haspopup="dialog" aria-expanded="false"
                                                aria-controls="hs-scale-animation-modal-ubah-laporan-{{ $b->id }}"
                                                data-hs-overlay="#hs-scale-animation-modal-ubah-laporan-{{ $b->id }}"
                                                class="bg-amber-400 hover:bg-amber-500 text-white font-bold py-2 px-4 rounded transition ease-in-out duration-150">
                                    ...
                                    <!-- Modal Ubah Laporan -->
                                    <div id="hs-scale-animation-modal-ubah-laporan-{{ $b->id }}"
                                        class="hs-overlay hs-overlay-backdrop-open:bg-black/80 hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none"
                                        role="dialog" tabindex="-1"
                                        aria-labelledby="hs-scale-animation-modal-label-ubah-laporan-{{ $b->id }}">
                                        <div
                                            class="hs-overlay-animation-target hs-overlay-open:scale-100 hs-overlay-open:opacity-100 scale-95 opacity-0 ease-in-out transition-all duration-200 sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
                                            <div
                                                class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
                                                ...
                                                <div class="p-4 overflow-y-auto">
                                                    <form action="{{ route('bug-reports.update', $b->id) }}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <textarea id="bug" name="bug_description" class="custom-input h-32" required
                                                                oninvalid="this.setCustomValidity('Kolom ini harus diisi')" oninput="this.setCustomValidity('')">{{ old('bug_description', $b->bug_description) }}
                                                                    </textarea>
                                                        </div>
                                                        <div>
                                                            ...
                                                            <input type="file" id="screenshot" name="screenshot"
                                                                accept="image/*" class="custom-input">
                                                            @if ($b->screenshot_path)
                                                                <p class="text-sm text-gray-500 mt-2">
                                                                    Screenshot saat ini :
                                                                    <a href="{{ asset('storage/' . $b->screenshot_path) }}"
                                                                        target="_blank"
                                                ...
                                                <div class="p-4 overflow-y-auto">
                                                    <div class="p-4">
                                                        <p>
                                                            ...
                                                            <strong>{{ $b->bug_description }}</strong>
                                                            ?
                                                        </p>
                                                    </div>
                                                    <div class="flex justify-end mt-4">
                                                        <form action="{{ route('bug-reports.destroy', $b->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
