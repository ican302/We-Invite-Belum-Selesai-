<x-app-layout>
    <div class="mx-auto px-4 py-20">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Daftar Undangan -->
            <div class="w-full">
                <h1 class="text-3xl font-bold mb-10 text-center font-croissant">Undangan Anda</h1>
                @foreach ($invitations as $invitation)
                    <div class="bg-white my-5 p-6 rounded-lg shadow-lg">
                        <h2 class="font-semibold text-lg">{{ $invitation->title }}</h2>
                        <p class="text-gray-600 mt-5">Tema : <span
                                class="font-medium">{{ $invitation->theme->name }}</span></p>
                        <hr class="my-2">
                                            ...
                                            <tr class="bg-white border-b text-nowrap">
                                                ...
                                                <td class="px-6 py-4 flex justify-end gap-2">
                                                    <button id="copyButton_{{ $guest->id }}"
                                                        onclick="copyLink('{{ route('invitation.show.guest', ['slug' => $invitation->slug, 'guestName' => Str::slug($guest->nama_tamu)]) }}', 'copyButton_{{ $guest->id }}')"
                                                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition ease-in-out duration-150 flex items-center gap-2">
                            ...
                            <div class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto">
                                ...
                                <div class="p-4 overflow-y-auto">
                                    ...
                                    <div class="flex justify-end mt-4">
                                        <form action="{{ route('user.invitation.destroy', $invitation) }}"
