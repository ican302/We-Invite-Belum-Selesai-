                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="p-4 overflow-y-auto">
                                        <form action="{{ route('user.kadodigital.update', $kd->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <div class="mb-6">
                                                <label for="penerima"
                                                ...
                                                <input type="text" id="penerima" name="penerima"
                                                    ...
                                                    oninput="this.setCustomValidity('')" value="{{ $kd->penerima }}">
                                            </div>
                                            <div class="mb-6">
                                                <label for="nama_bank"
                                                    class="block mb-2 text-sm font-medium text-gray-900">
                                                ...
                                                <input type="text" id="nama_bank" name="nama_bank"
                                                    class="custom-input" required
                                                    oninvalid="this.setCustomValidity('Kolom ini harus diisi')"
                                                    oninput="this.setCustomValidity('')" value="{{ $kd->nama_bank }}">
                                            </div>
                                            <div class="mb-6">
