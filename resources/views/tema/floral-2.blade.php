...
<body class="antialiased" style="background-color: #75dac9; overflow: hidden;">
    ...
    <div id="cover-page" class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        style="background-image: url('{{ asset('tema/floral-2/images/bg.jpg') }}'); background-position: center; background-size: cover;">
        <!-- Flash Message -->
        ...
        <div class="absolute top-0 right-0 z-10">
            <img src="{{ asset('tema/floral-2/images/corner-1.png') }}" alt="Corner 1"
                class="w-[200px] h-auto md:w-[250px]">
        </div>
        <div class="absolute bottom-0 left-0 z-10">
            <img src="{{ asset('tema/floral-2/images/corner-2.png') }}" alt="Corner 2"
                class="w-[200px] h-auto md:w-[250px]">
        </div>
        <div
    ...
    <div id="main-invitation"
        class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        style="background-image: url('{{ asset('tema/floral-2/images/bg.jpg') }}'); background-position: center; background-size: cover;">
        <div class="absolute top-0 right-0 z-10">
            <img src="{{ asset('tema/floral-2/images/corner-1.png') }}" alt="Corner 1"
                class="w-[200px] h-auto md:w-[250px]">
            ...
            <div class="mx-auto my-5">
                ...
                <div class="flex flex-col items-center justify-center space-y-4 mb-5 mt-10">
                    ...
                    <div class="flex flex-col items-center justify-center text-center" data-aos="fade-right"
                        ...
                        <div class="mt-5">
                            <div class="font-bold font-croissant text-[#359484]">
                                {{ $invitation->mempelai ? $invitation->mempelai->nama_pria : '-' }}
                            </div>
                            <div class="font-montserrat text-sm text-gray-600 my-1">
                            ...
                            <div class="font-montserrat text-sm text-gray-600 my-1 pb-3">
    ...
    @if ($invitation->acara->isNotEmpty())
        <div class="relative flex flex-col justify-center items-center min-h-screen w-full mx-auto max-w-[500px] p-10"
            style="background-image: url('{{ asset('tema/floral-2/images/bg.jpg') }}'); background-position: center; background-size: cover;">
            <div class="absolute top-0 right-0 z-10">
                <img src="{{ asset('tema/floral-2/images/corner-1.png') }}" alt="Corner 1"
                    class="w-[200px] h-auto md:w-[250px]">
        ...
        <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
            ...
            <div
                ...
                <div class="mx-auto my-5">
                    <div
                        class="grid grid-cols-1 gap-6 text-center items-center mx-auto max-w-lg lg:max-w-4xl font-montserrat">
                        <div class="text-[#359484] text-2xl font-bold font-croissant" data-aos="zoom-in"
                            data-aos-easing="ease-in-sine" data-aos-duration="800">
                            Live Streaming
                        </div>
                        <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                            <div class="flex justify-center text-center items-center text-sm">
                                <a href="{{ $invitation->streaming->link_streaming }}" target="__blank"
                                    class="bg-[#359484] text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-[#359484] focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    <!-- Galeri & Cerita -->
    @if (
        ($invitation->galeri && ($invitation->galeri->video_galeri || $invitation->galeri->foto_galeri)) ||
            ...
            <div
                ...
                <div class="mx-auto my-28">
                    ...
                    @if ($invitation->cerita && $invitation->cerita->isNotEmpty())
                        <div class="text-[#359484] text-2xl font-bold font-croissant mt-10 text-center"
                            data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-duration="800">
                            Cerita
                        </div>
                    @endif
                        ...
                        @foreach ($invitation->cerita as $cerita)
                            <div class="ml-[15px] mb-5" data-aos="fade-up" data-aos-easing="ease-in-sine"
                                ...
                                <div class="bg-white rounded-lg shadow-md text-center border"
                                    style="filter: drop-shadow(-15px 15px 2px #359484);">
            ...
            <div
                ...
                <div class="mx-auto my-5 w-full">
                    ...
                    <form action="{{ route('comments.store', $invitation->id) }}" method="POST"
                        data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="800" class="w-full">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="text-center">
                            <button type="submit"
                                class="text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-[#359484] focus:ring-offset-2 transition ease-in-out duration-150 font-montserrat"
                                style="background-color: #359484;">
                                <span>Kirim</span>
    ...
    <!-- RSVP -->
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        style="background-image: url('{{ asset('tema/floral-1/images/bg.jpg') }}'); background-position: center; background-size: contain;">
        <div class="absolute top-0 left-0 z-10">
            <img src="{{ asset('tema/floral-1/images/corner-1.png') }}" alt="Corner 1"
                class="w-[200px] h-auto md:w-[250px]">
        </div>
        <div class="absolute bottom-0 right-0 z-10">
            <img src="{{ asset('tema/floral-1/images/corner-2.png') }}" alt="Corner 2"
                class="w-[200px] h-auto md:w-[250px]">
        </div>
        <div
            class="bg-trans rounded-3xl shadow-lg p-8 m-5 flex flex-col justify-center items-center relative z-10 w-full h-auto max-w-[370px]">
                ...
                <form action="{{ route('rsvp.store', $invitation->id) }}" method="POST" data-aos="fade-up"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="message" name="pesan" rows="4"
                            class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 sm:text-sm font-montserrat"
                            placeholder="Tulis pesan di sini..." required style="outline: none;"
                            onfocus="this.style.borderColor='#359484'; this.style.boxShadow='0 0 0 1px #359484';"
                            onblur="this.style.borderColor='#d1d5db'; this.style.boxShadow='none';"
                            oninvalid="this.setCustomValidity('Kolom ini harus diisi')" oninput="this.setCustomValidity('')"></textarea>
                    </div>
    ...
    @if ($invitation->kadodigital->isNotEmpty())
        <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
            ...
            <div
                class="bg-trans rounded-3xl shadow-lg p-8 m-5 flex flex-col justify-center items-center relative z-10 w-full h-auto max-w-[370px]">
                <div class="mx-auto my-5">
                    <div class="text-center text-[#359484] text-2xl font-bold mb-5 font-croissant" data-aos="zoom-in"
                        data-aos-easing="ease-in-sine" data-aos-duration="800">
                        Kado Digital
                    </div>
                    <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                        ...
                        @foreach ($invitation->kadodigital as $kado)
                            ...
                            <div class="w-full text-center">
                                ...
                                <p class="text-[#359484] font-montserrat">{{ $kado->nama_bank }}</p>
                                <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                                <p class="text-[#359484] font-montserrat">{{ $kado->penerima }}</p>
                                <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                                <p id="nomor_rekening_{{ $kado->id }}"
                                    class="text-[#359484] font-montserrat mb-4">
                                    {{ $kado->no_rekening }}
                                </p>
                            </div>
                            <div class="mb-4 text-center">
                                <button id="copyButton_{{ $kado->id }}" type="button"
                                    ...
                                    class="text-sm text-nowrap text-white py-2 px-6 rounded focus:outline-none focus:ring-2 focus:ring-[#359484] focus:ring-offset-2 transition ease-in-out duration-150 font-montserrat"
                                    style="background-color: #359484;">
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div
            ...
            <div class="mx-auto">
                <div class="text-sm text-center" data-aos="fade-left" data-aos-easing="ease-in-sine"
                    data-aos-duration="800">
