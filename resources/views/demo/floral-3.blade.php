...
<body class="antialiased" style="background-color: #c7b098; overflow: hidden;">
    ...
    <div id="cover-page" class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div class="absolute top-0 left-0 z-10">
            <img src="{{ asset('tema/floral-3/images/corner-2.png') }}" alt="Corner 2"
                class="w-[150px] h-auto md:w-[200px]">
        </div>
        ...
        <div
            ...
            <div class="mx-auto my-5">
                <div class="text-center" data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-duration="800">
                    ...
                    <div class="font-montserrat text-sm mt-2 px-2">
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div
            ...
            <div class="mx-auto my-28">
                ...
                <div class="grid grid-cols-2 gap-4 py-5" data-aos="fade-left" data-aos-easing="ease-in-sine"
                    data-aos-duration="800">
                ...
                <div class="text-[#8a6949] text-2xl font-bold font-croissant mt-10 text-center" data-aos="zoom-in"
        ...
        <div
            ...
            <div class="mx-auto my-5">
                ...
                <form action="#" method="POST" data-aos="fade-right" data-aos-easing="ease-in-sine"
                    data-aos-duration="800" class="w-full">
                    <div class="mb-4">
            ...
            <div class="mx-auto my-5">
                ...
                <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                    ...
                    <div class="w-full text-center">
                        ...
                        <p class="text-[#8a6949] font-montserrat">BCA</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                        <p class="text-[#8a6949] font-montserrat">Rizky Syaputra</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                        <p id="nomor_rekening_1" class="text-[#8a6949] font-montserrat mb-4">
                            12345678910
                        </p>
                    </div>
                    ...
                    <div class="w-full text-center">
                        ...
                        <p class="text-[#8a6949] font-montserrat">BCA</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                        <p class="text-[#8a6949] font-montserrat">Ana Lutfiani</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                        <p id="nomor_rekening_2" class="text-[#8a6949] font-montserrat mb-4">
                            10987654321
                        </p>
                    </div>
                    <div class="mb-4 text-center">
