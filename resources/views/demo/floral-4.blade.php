...
<body class="antialiased" style="background-color: #f3a2a2; overflow: hidden;">
    ...
    <div id="cover-page" class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        style="background-image: url('{{ asset('tema/floral-4/images/bg.webp') }}'); background-position: center; background-size: cover;">
        <div class="absolute top-0 left-0 z-10">
            <img src="{{ asset('tema/floral-4/images/corner-1.png') }}" alt="Corner 1"
                class="w-[200px] h-auto md:w-[250px]">
        </div>
        <div class="absolute bottom-0 right-0 z-10">
            <img src="{{ asset('tema/floral-4/images/corner-2.png') }}" alt="Corner 2"
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div
            ...
            <div class="mx-auto my-5">
                <div
                    class="grid grid-cols-1 gap-6 text-center items-center mx-auto max-w-lg lg:max-w-4xl font-montserrat">
                    <div class="text-[#d66b6b] text-2xl font-bold font-croissant" data-aos="zoom-in"
                        data-aos-easing="ease-in-sine" data-aos-duration="800">
                        Live Streaming
                    </div>
                    <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                        <div class="flex justify-center text-center items-center text-sm">
                            <a href="https://youtube.com" target="__blank"
                                class="bg-[#d66b6b] text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-[#d66b6b] focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div
            ...
            <div class="mx-auto my-28">
                ...
                <div class="text-[#d66b6b] text-2xl font-bold font-croissant mt-10 text-center" data-aos="zoom-in"
                ...
                <div class="ml-[15px] mb-5" data-aos="fade-up" data-aos-easing="ease-in-sine"
                    ...
                    <div class="bg-white rounded-lg shadow-md text-center border"
                        style="filter: drop-shadow(-15px 15px 2px #d66b6b);">
        ...
        <div
            ...
            <div class="mx-auto my-5">
                ...
                <form action="#" method="POST" data-aos="fade-right" data-aos-easing="ease-in-sine"
                    ...
                    <div class="text-center">
                        <button type="submit"
                            class="text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-[#d66b6b] focus:ring-offset-2 transition ease-in-out duration-150 font-montserrat"
                            style="background-color: #d66b6b;">
                            <span>Kirim</span>
    ...
    <div class="relative flex justify-center items-center min-h-screen w-full mx-auto max-w-[500px]"
        ...
        <div
            class="bg-trans rounded-3xl shadow-lg p-8 m-5 flex flex-col justify-center items-center relative z-10 w-full h-auto max-w-[370px]">
            <div class="mx-auto my-5">
                <div class="text-center text-[#d66b6b] text-2xl font-bold mb-5 font-croissant" data-aos="zoom-in"
                    data-aos-easing="ease-in-sine" data-aos-duration="800">
                    Kado Digital
                </div>
                <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                    ...
                    <div class="w-full text-center">
                        ...
                        <p class="text-[#d66b6b] font-montserrat">BCA</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                        <p class="text-[#d66b6b] font-montserrat">Rizky Syaputra</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                        <p id="nomor_rekening_1" class="text-[#d66b6b] font-montserrat mb-4">
                            12345678910
                        </p>
                    </div>
                    <div class="mb-4 text-center">
                        <button id="copyButton_1" type="button" onclick="copyToClipboard(1)"
                            class="text-sm text-nowrap text-white py-2 px-6 rounded focus:outline-none focus:ring-2 focus:ring-[#d66b6b] focus:ring-offset-2 transition ease-in-out duration-150 font-montserrat"
                            style="background-color: #d66b6b;">
                    ...
                    <div class="w-full text-center">
                        ...
                        <p class="text-[#d66b6b] font-montserrat">BCA</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                        <p class="text-[#d66b6b] font-montserrat">Ana Lutfiani</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                        <p id="nomor_rekening_2" class="text-[#d66b6b] font-montserrat mb-4">
                            10987654321
                        </p>
                    </div>
                    <div class="mb-4 text-center">
