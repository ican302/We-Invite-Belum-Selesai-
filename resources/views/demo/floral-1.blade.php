            ...
            <div class="mx-auto my-5">
                ...
                <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                    ...
                    <div class="w-full text-center">
                        ...
                        <p class="text-[#4B6B99] font-montserrat">BCA</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                        <p class="text-[#4B6B99] font-montserrat">Rizky Syaputra</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                        <p id="nomor_rekening_1" class="text-[#4B6B99] font-montserrat mb-4">
                            12345678910
                        </p>
                    </div>
                    ...
                    <div class="w-full text-center">
                        ...
                        <p class="text-[#4B6B99] font-montserrat">BCA</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Atas Nama :</p>
                        <p class="text-[#4B6B99] font-montserrat">Ana Lutfiani</p>
                        <p class="mt-4 text-gray-800 font-montserrat">Nomor Rekening :</p>
                        <p id="nomor_rekening_2" class="text-[#4B6B99] font-montserrat mb-4">
                            10987654321
                        </p>
                    </div>
                    <div class="mb-4 text-center">
